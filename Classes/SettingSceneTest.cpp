...
Scene* SettingSceneTest::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = SettingSceneTest::create();
...
bool SettingSceneTest::init()
{
    ...
    auto closeItem = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(SettingSceneTest::GoBackToMainSceneCallback, this));
    ...
    auto label = Label::createWithTTF("Setting Scene Test", "fonts/Marker Felt.ttf", 24);
...
void SettingSceneTest::GoBackToMainSceneCallback(Ref* pSender)
{
